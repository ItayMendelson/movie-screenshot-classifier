...
def parse_args():
    ...
    parser.add_argument(
        "--no-save",
        action="store_true",
        help="Train without saving checkpoints/baseline_model.pt.",
    )
    parser.add_argument(
        "--smoke-test",
        action="store_true",
...
def main():
    ...
    if args.smoke_test or args.no_save:
        ...
        torch.save(model.state_dict(), "checkpoints/baseline_model.pt")
        print("saved checkpoints/baseline_model.pt")
